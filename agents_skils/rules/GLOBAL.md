...
# GLOBAL.md - Regras Globais do Sistema de Agentes

> Este arquivo define como a IA se comporta neste workspace. Compativel com qualquer modelo de IA.
...
- **Rule Priority:** P0 (AGENT.md) > P1 (Agent .md) > P2 (SKILL.md). All rules are binding.
...
```
NOT: Read agent file -> Start coding
YES: Read -> Understand WHY -> Apply PRINCIPLES -> Code
```
