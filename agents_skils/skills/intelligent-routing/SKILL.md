...
### With GLOBAL.md Rules

- **Priority**: GLOBAL.md rules > intelligent-routing
- If GLOBAL.md specifies explicit routing, follow it
...
**Next Steps**: Integrate this skill into GLOBAL.md TIER 0 rules.
