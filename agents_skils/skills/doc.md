...
> **Guide to creating and using Skills in the Agent System**

---

## 📋 Overview

While AI models are powerful generalists, they don't know your specific project context or your team's standards. Loading every rule or tool into the agent's context window leads to "tool bloat," higher costs, latency, and confusion.
